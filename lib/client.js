...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /* Monotonically increasing suffix so two buttons created in the same
     * millisecond never share an id (Date.now() alone can collide, which would
     * produce duplicate React keys and ambiguous settings rows). */
    var uidSeq = 0;
